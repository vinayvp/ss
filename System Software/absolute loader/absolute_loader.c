...
int addr, w = 0, start, ptaddr, l, length = 0, end, count = 0, k, taddr, cur_address, i = 0;
FILE *fp1, *fp2;
void check();
void main()
{
    fp1 = fopen("obj_prgm.txt", "r");
    fp2 = fopen("OUTPUT.txt", "w");
    fscanf(fp1, "%s", input);
    printf("\n\n\tAbsolute  Loader\nprinting....");
    fprintf(fp2, "\n.......................................................\n");
    fprintf(fp2, "Memory Addr\t\t\tcontents");
    fprintf(fp2, "\n.......................................................\n");
    ...
    //         printf("%s %x %x %s", label, start, end, input);
    //         cur_address = start;
    //     }
