...
//This function dynamically updates the ARGTAB (Argument TAble) 
void argu()
{
    FILE *f4;
...
//This function fetches the arguments used in that particular macro call
...
void main()
{
    ...
    //Pass2 of Two-Pass Macroprocessor
